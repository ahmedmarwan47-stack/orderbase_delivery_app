...
class LiquidTabBarController extends ChangeNotifier {
  ...
  void _onTimings(List<FrameTiming> timings) {
    if (effectiveMaterial != LiquidTabBarMaterial.glass) return;
  ...
  /// Call once [LiquidGlass.load] has completed so the governor can arm
  /// itself (it only watches while the glass tier is on).
