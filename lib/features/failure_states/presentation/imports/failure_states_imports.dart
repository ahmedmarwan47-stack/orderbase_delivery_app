...
///   1e Return to branch · 1g Returns list.
///
/// 1a–1e are bottom sheets shown over the order-detail context; 1g is a full
...
// Controllers (ephemeral UI state — ValueNotifier, never setState)
...
// Sheets (1a–1e) — private to the feature
