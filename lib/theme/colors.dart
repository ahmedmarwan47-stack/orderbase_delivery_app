...
abstract final class AppColors {
  ...
  static const surfaceMuted = Color(
    0xFFF4F3F0,
  ); // chips, search field, icon buttons
  static const surfaceSubtle = Color(
    0xFFF1F0ED,
  ); // dividers, empty-state icon bg
  ...
  static const borderCardFaint = Color(
    0x0A000000,
  ); // rgba(0,0,0,.04) hero/stat card
  static const iconButtonBorder = Color(
    0x12000000,
  ); // rgba(0,0,0,.07) header search icon button (Home 1a)
  ...
  static const textMuted = Color(
    0xFF7C6C63,
  ); // address lines, hints — AA on white (5.03:1)
  ...
  static const postponedBorderStrong = Color(
    0xFFE6D6B4,
  ); // button outline variant
  static const postponedText = Color(0xFF9A5A00);
  static const postponedTextStrong = Color(0xFF6B4A12); // body copy on banner
  static const heroCodPillBg = Color(
    0xFFFBF0DE,
  ); // COD pill inside the hero card
  static const pickupBannerBorder = Color(
    0xFFF3DDB4,
  ); // "ready for pickup" banner
  static const pickupBannerText = Color(
    0xFF7A4E12,
  ); // "ready for pickup" banner copy
  ...
  static const summaryDivider = Color(
    0xFFEAE9E5,
  ); // divider inside the result summary card
  ...
  static const paymentTile = Color(
    0x26FFFFFF,
  ...
  static const timelineRing = Color(
    0xFFF7D7D6,
  ); // ring around the active red dot
  ...
  static const dashedBorder = Color(
    0xFFD6D5D1,
  ); // photo-capture dashed border + switch-off track
  ...
  static const photoGreenWash = Color(
    0x2416A34A,
  ); // rgba(22,163,74,.14) captured-photo overlay
  static const reasonRowBg = Color(0xFFF8F7F5); // unselected reason row
  static const reasonDotBorder = Color(
    0xFFCFCEC9,
  ); // unselected reason radio ring

  // Failure States (Failure States.dc.html) — the not-delivered flow.
  static const transitPillBg = Color(
    0xFFE7F0FB,
  ); // pale "في الطريق" pill / tile bg
  static const failWarnAmberBorder = Color(
    0xFFF0DFBC,
  ); // 1b "last nudge" warning card border
  static const failWarnAmberText = Color(0xFF7A4A00); // 1b warning body text
  static const failWarnRedBorder = Color(
    0xFFF5CFCE,
  ); // 1d mismatch warning card border
  static const failWarnRedText = Color(
    0xFF8E1512,
  ); // 1d mismatch warning body text
  static const retryNowSubtext = Color(
    0xFF4A6B55,
  ); // 1c retry-now green caption
  static const darkCardRowBg = Color(
    0xFF2A2927,
  ); // 1g return-item row on the dark card
  static const undoTrack = Color(
    0xFF3A3937,
  ); // 1f undo progress track (unfilled)
  static const mutedOnDark = Color(
    0xFFA3A29E,
  ); // warm muted text on dark cards (1f/1g)
  ...
  static const flatDivider = Color(
    0xFFE8E7E3,
  ); // Flat (2a) hairline dividers / circle button border
  static const flatBlack = Color(
    0xFF000000,
  ); // Flat (2a) primary button + banner text; batch cash total
  static const flatBannerBg = Color(
    0xFF898989,
  ); // Flat (2a) grey "today's overview" banner
  static const flatMutedDot = Color(
    0xFFC6C5C0,
  ); // Flat (2a) chevron + meta separator dot
  static const darkTileLabel = Color(
    0xFFCCCCD0,
  ); // Compact (1c) muted label on the dark collection tile
  static const cashSuffixGreen = Color(
    0xFF7BDDA3,
  ); // lighter green "جم" suffix on the dark cash banner/tile
  static const cashTileWash = Color(
    0x263BD07A,
  ); // rgba(59,208,122,.15) icon-tile wash on the dark cash banner
  static const onlineBarBorder = Color(
    0x4016A34A,
  ); // rgba(22,163,74,.25) "you're online" bar border (Glance 1b)
  static const onlineDotGlow = Color(
    0x2E16A34A,
  ); // rgba(22,163,74,.18) green online-dot glow (Glance 1b)
  static const softDropShadow = Color(
    0x2E000000,
  ); // rgba(0,0,0,.18) soft card drop shadow (Flat/Compact route cards)
  static const deepDropShadow = Color(
    0x80000000,
  ); // rgba(0,0,0,.5) deep drop shadow on the dark cash banner (Glance 1b)
}
