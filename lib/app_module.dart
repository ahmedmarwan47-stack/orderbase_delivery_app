...
///
/// Every screen is now migrated to the Flutter_Base feature structure; the tab
/// shell lives at `/`, pushed screens (order detail, pickup) get named routes.
class AppModule extends Module {
  ...
  void routes(RouteManager r) {
    r.child('/', child: (_) => const AppShell());
    r.child('/auth',
        child: (_) => LoginScreen(onSubmit: () => Modular.to.navigate('/')));
